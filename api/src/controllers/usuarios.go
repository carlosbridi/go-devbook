...
// Seguir usuário permite que um usuário siga o outro
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(banco)
...
func DeixarDeSeguir(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioId == seguidorID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível deixa de se seguir"))
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioId != usuarioIdToken {
		respostas.JSON(w, http.StatusForbidden, errors.New("Não é possível atualizar senha de outro usuário"))
		return
	}
	...
	if erro = seguranca.VerificarSenha(senhaSalvaBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("Senha atual não condiz com a senha salva no banco"))
		return
	}
